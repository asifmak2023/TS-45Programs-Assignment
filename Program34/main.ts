...
console.clear();
const pizza_names : string[] =  ["Marinara", "Margherita", "Mamma Mia"];
const pizza_ingredients : string[] = ["Marinara sauce, Garlic, Olive oil, Basil, Oregano", "San Marzano tomato sauce, Mozzarella di bufala, Olive Oil", "Tomato sauce, Mozzarella, Tuna, Peppers, Corn, Onions"]
